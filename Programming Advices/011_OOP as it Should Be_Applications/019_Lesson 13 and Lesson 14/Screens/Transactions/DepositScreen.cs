...
{
    internal class DepositScreen : Screen
    {
        ...
        public static void deposit()
        {
            ...
            if (Console.ReadLine().ToLower() == "y")
            {
                ...
                foreach (BankClient bankClient in clientsList)
                {
                    ...
                    {
                        clientToUpdate.AccountBalance += depositAmount;
                        break;
                    }
                }
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("Client ({0}) Account Balance Updated Successfully", accountNumber);
